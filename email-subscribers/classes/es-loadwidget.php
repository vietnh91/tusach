...
class es_cls_widget {
	...
	public static function load_subscription($arr) {
		...
		$es = $es . '<input class="es_textbox_class" name="es_txt_email_pg" id="es_txt_email_pg" placeholder="Email..." value="" maxlength="225" type="text">';

		#$es = $es . '</div>';

		#$es = $es . '<div class="es_button">';

			$es = $es . '<input class="es_textbox_button" name="es_txt_button_pg" id="es_txt_button_pg" onClick="return es_submit_pages('.$url.')" value="Đăng ký" type="button">';
